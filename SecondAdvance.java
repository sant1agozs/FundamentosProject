      ...
      switch (opcion) {
        case "1":
          if (!enigmaNumericoResuelto) {
            ...
            out.println("Este desafío ya ha sido completado.");
          }
          break;
          ...
          if (!cuadroContradiccionResuelto) {
            ...
            do {
              ...
              if (g1.equals("adreiuqzi") && g2.equals("ahcered") && g3.equals("adreiuqzi") &&
                ...
                logroCuadro = true;
                cuadroContradiccionResuelto = true;
                minijuegosCompletados++;
              } else {
        ...
        case "7":
          ...
          out.println("Desafíos completados:");
          out.println("1. Enigma Numérico completado?: " + enigmaNumericoResuelto);
          out.println("2. Caja de Colores completado?: " + cajaColoresResuelta);
          out.println("3. El Libro de la Sombra completado?: " + libroSombraResuelto);
          out.println("4. Códigos de Tiza completado?: " + codigosTizaResuelto );
          out.println("5. El Cajón de la Contradicción completado?: " + cuadroContradiccionResuelto);
          out.println("6. Las Manecillas del Juicio completado?: " + manecillasJuicioResuelto);
